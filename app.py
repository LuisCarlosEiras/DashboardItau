...
# Referências
st.write("""Referência: Mini Projeto 2, Data App, Dashboard Financeiro Interativo e em Tempo Real Para Previsão de Ativos Financeiros, 
Curso Visualização de Dados e Design de Dashboards, Data Science Academy""")
